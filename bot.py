...
async def start(event):
  await event.reply("**KrakadilTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/Krakadiltaggerbot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/KrakadilSupport'),
                      Button.url('🚀 Sahibim', 'https://t.me/AliSafarofh')]
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**Krakadiltagger bot'un Yardım Menüsü**\n\nKomut: /all \n  Bu komutu, başkalarına bahsetmek istediğiniz metinle birlikte kullanabilirsiniz. \n`Örnek: /all Günaydın!`  \nBu komutu yanıt olarak kullanabilirsiniz. herhangi bir mesaj Bot, yanıtlanan iletiye kullanıcıları etiketleyecek"
...
print(">> Bot çalıyor merak etme 🚀 @AliSafarofh bilgi alabilirsin <<")
